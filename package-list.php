...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					...
					<h6><?php echo htmlentities($result->PackageLocation);?></h6>
					<p><b>Places to visit <br></b> <?php echo htmlentities($result->PackageFetures);?></p>
				</div>
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5>Approximate Budget <br>₹<?php echo htmlentities($result->PackagePrice);?></h5>

...
<!--	<script type="text/javascript">
    (function(d, m){
        var kommunicateSettings = 
            {"appId":"d660651f57871e0755c7528abf3f9483","popupWidget":true,"automaticChatOpenOnNavigation":true};
...
<df-messenger
  intent="WELCOME"
  chat-title="Safarnama"
  agent-id="b01c8b4c-822f-46d5-ada1-4376933b8b5c"
  language-code="en"
></df-messenger>
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					...
					<p><b>Places to Visit</b> <?php echo htmlentities($result->PackageFetures);?></p>
				</div>
...
<!-- Blogs card section starts from here 
